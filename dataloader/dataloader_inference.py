...
class DataLoader_inference:
    ...
    def preprocess_onhot_encoder(Y_train_set):
        ...
        y_train = DataLoader_inference.one_hot(Y_train_set, n_class=12)
    ...
    def preprocess_standardize_train_dataset(x_train_set, x_test_set):
        ...
        X_train_dataset = DataLoader_inference.standardize(x_train_set)
        X_test_dataset = DataLoader_inference.standardize(x_test_set)
    ...
    def collect_save_data(subject_count, mblock_size):
        ...
        for s in range(1, subject_count + 1):
            # Read the data
            df = DataLoader_inference.read_subject(s)

            # Split into blocks
            x, y = DataLoader_inference.split_by_blocks(df, mblock_size)
